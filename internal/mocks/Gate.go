...
func (_m *Gate) CreatePayment(order *billingpb.Order, successUrl string, failUrl string, requisites map[string]string) (string, error) {
...
func (_m *Gate) CreateRefund(order *billingpb.Order, refund *billingpb.Refund) error {
...
func (_m *Gate) GetRecurringId(request protoiface.MessageV1) string {
...
func (_m *Gate) IsRecurringCallback(request protoiface.MessageV1) bool {
	ret := _m.Called(request)
...
func (_m *Gate) ProcessPayment(order *billingpb.Order, message protoiface.MessageV1, raw string, signature string) error {
...
func (_m *Gate) ProcessRefund(order *billingpb.Order, refund *billingpb.Refund, message protoiface.MessageV1, raw string, signature string) error {
