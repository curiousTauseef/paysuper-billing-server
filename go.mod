...
require (
	...
	github.com/paysuper/paysuper-proto/go/billingpb v0.0.0-20201007094727-ed62594bcae0
	...
	github.com/paysuper/paysuper-proto/go/recurringpb v0.0.0-20201007093934-6204a9dd0a68
