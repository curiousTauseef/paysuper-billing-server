...
require (
	...
	github.com/paysuper/paysuper-proto/go/billingpb v0.0.0-20201023054850-28780cc483d1
	...
	github.com/paysuper/paysuper-proto/go/recurringpb v0.0.0-20201022135246-4ebd69aacba2
