...
require (
	...
	github.com/paysuper/paysuper-proto/go/billingpb v0.0.0-20201006125912-694e39cb3d7b
	...
	github.com/paysuper/paysuper-proto/go/recurringpb v0.0.0-20201006130331-b4dd85ee9e61
