...
require (
	...
	github.com/paysuper/paysuper-proto/go/billingpb v0.0.0-20201015134832-e69cd8f4fe59
	...
	github.com/paysuper/paysuper-proto/go/recurringpb v0.0.0-20201008074348-299d9442d4ad
